...
export const vi = {
  ...
  'places.filter.area': 'Khu vực khám phá',
  'places.filter.areaHint': 'Tìm khu vực…',
  ...
  'placeEditor.areaKey': 'Khu vực khám phá',
  'placeEditor.areaKeyHint':
    'Khoá lấy từ danh mục khu vực; dùng để tìm kiếm và lọc, không phải địa chỉ hành chính.',
  ...
  'publishChecklist.item.area': 'Có khu vực',
