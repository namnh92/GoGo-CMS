...
export const en: Partial<Record<MessageKey, string>> = {
  ...
  'places.hierarchy.emptyProvince': 'No places under any ward or commune of this province yet.',
  'places.hierarchy.unresolved': 'Unresolved / needs review',
  'places.hierarchy.bucket.NEEDS_REVIEW': 'Needs review',
  'places.hierarchy.bucket.UNMAPPED': 'Unmapped',
  'places.hierarchy.bucket.STALE': 'Stale mapping',
  'places.hierarchy.bucket.REJECTED': 'Rejected',
  'places.hierarchy.bucket.INVALID_HIERARCHY': 'Invalid hierarchy',
  'places.hierarchy.clear': 'Clear the area filter',
  'places.hierarchy.note':
    'Counts read the stored administrative codes under the filters the table beside them is showing. Archived places are excluded unless you filter for them.',
  'places.col.administrative': 'Administrative address',
  'places.administrative.none': 'Not resolved',
  'places.tab.all': 'All',
  ...
  'submissions.noName': 'No name yet',
  'submissions.noNameHint':
    'GoGo does not store Google’s name. Open the submission to fetch Google data and name it.',
  'submissions.nameFrom.review': 'Named by a reviewer',
  'submissions.nameFrom.catalogue': 'Name of the catalogue place',
  'submissions.hasReview': 'Supplemented',
  'submissions.duplicate': 'Already in the catalogue',
  'submissions.identityConflict': 'Identity conflict',
  'submissions.identityConflictHint':
    'Two GoGo places claim this Google ID. Merge them before approving.',
  'submissions.open': 'Open for review',
  'submissions.reviewTitle': 'Review submission',
  'submissions.section.identity': 'Identity',
  'submissions.section.provider': 'Google data',
  'submissions.section.contribution': 'What the user sent',
  'submissions.section.review': 'Reviewer supplement',
  'submissions.section.decision': 'Decision',
  'submissions.section.history': 'History',
  'submissions.field.placeId': 'Google Place ID',
  'submissions.field.googleLink': 'Open in Google Maps',
  'submissions.field.createdAt': 'Submitted',
  'submissions.field.status': 'Status',
  'submissions.field.category': 'Category the user chose',
  'submissions.field.note': 'User note',
  'submissions.field.address': 'Address',
  'submissions.field.coordinates': 'Coordinates',
  'submissions.field.rating': 'Google rating',
  'submissions.field.hours': 'Google opening hours',
  'submissions.field.administrative': 'Proposed province/commune',
  'submissions.openMap': 'View on the map',
  'submissions.loadProvider': 'Fetch Google data',
  'submissions.reloadProvider': 'Fetch again',
  'submissions.providerCost':
    'Each fetch is one Google Place Details request and is counted separately. GoGo stores none of it.',
  'submissions.providerEmpty': 'Google data has not been fetched for this submission.',
  'submissions.providerFailed': 'Could not reach Google right now.',
  'submissions.providerAttribution': 'Source: {names}',
  'submissions.ratingValue': '{score} · {count} ratings',
  'submissions.hoursCount': '{n} days with opening hours',
  'submissions.noHours': 'Google publishes no opening hours',
  'submissions.existingPlace': 'Existing place',
  'submissions.openPlace': 'Open place',
  'submissions.reviewHint':
    'These fields are GoGo’s. Leaving one blank keeps Google’s answer at approval.',
  'submissions.review.name': 'Display name',
  'submissions.review.description': 'Description',
  'submissions.review.address': 'Address',
  'submissions.review.phone': 'Phone',
  'submissions.review.website': 'Website',
  'submissions.review.avgVisitMinutes': 'Visit duration (minutes)',
  'submissions.review.priceMin': 'Price from (₫)',
  'submissions.review.priceMax': 'Price to (₫)',
  'submissions.review.priceUnit': 'Price unit',
  'submissions.review.taxonomy': 'Category, vibes and audiences',
  'submissions.review.addTaxonomy': 'Add a label',
  'submissions.review.save': 'Save supplement',
  'submissions.review.saved': 'Supplement saved. The submission is not decided.',
  'submissions.review.saveFailed': 'Could not save the supplement.',
  'submissions.review.stale': 'Somebody else just edited this submission. Reload and re-enter.',
  'submissions.review.unsaved': 'Unsaved supplement',
  'submissions.mergeSearch': 'Find a place to merge into',
  'submissions.mergeSearchHint': 'Type a place name; pick a result to confirm before merging.',
  'submissions.mergeSelected': 'Merging into: {name}',
  'submissions.mergeClear': 'Clear',
  'submissions.mergeNoResults': 'No places found',
  'submissions.afterDecision':
    'The place exists. Open it to verify the administrative mapping and publish.',
  'submissions.decisionsAreSeparate':
    'Approving a submission is neither administrative verification nor publication.',
}
