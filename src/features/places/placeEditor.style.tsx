export const styles = {
  ...
  sourceMeta: 'mt-2 grid grid-cols-[9rem_1fr] gap-x-3 gap-y-1 text-[11px]',
  sourceMetaKey: 'text-text-subtle',
  sourceMetaValue: 'text-text',
  sourceActions: 'mt-3 flex flex-wrap items-center gap-2',
